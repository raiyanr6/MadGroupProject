...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeNotification(){
        ...
        intent.putExtra("data", "Weather Alert: Heavy Rain Expected, Carry a Umbrella");
      ...
      notificationManager.notify(1, builder.build());
        ...
        // Third Notification
        NotificationCompat.Builder builder3 = new NotificationCompat.Builder(getApplicationContext(), channelID)
                .setSmallIcon(R.drawable.ic_notification)
                .setContentTitle("Climate C, " +
                        "Community")
                .setContentText("Haze detected in Klang Valley. Please wear a mask.")
                .setAutoCancel(true)
                .setPriority(NotificationCompat.PRIORITY_HIGH);

        Intent intent3 = new Intent(getApplicationContext(), NotificationActivity.class);
        intent3.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingIntent3 = PendingIntent.getActivity(getApplicationContext(), 2, intent3, PendingIntent.FLAG_MUTABLE);
